import { BarChart3, Bot, CalendarDays, CloudSun, Map, ShieldAlert, WalletCards } from 'lucide-react'
import { NavLink } from 'react-router-dom'

const links = [['/', 'Overview', BarChart3], ['planner', 'Planner', CalendarDays], ['maps', 'Maps', Map], ['budget', 'Budget', WalletCards], ['weather', 'Weather', CloudSun], ['emergency', 'Emergency', ShieldAlert], ['chatbot', 'Travel desk', Bot]]
