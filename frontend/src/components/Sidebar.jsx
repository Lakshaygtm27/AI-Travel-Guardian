...
const links = [['/', 'Overview', BarChart3], ['planner', 'Planner', CalendarDays], ['maps', 'Maps', Map], ['budget', 'Budget', WalletCards], ['weather', 'Weather', CloudSun], ['safety', 'Women safety', ShieldCheck], ['scams', 'Scam alerts', AlertTriangle], ['medical', 'Medical', Cross], ['emergency', 'Emergency', ShieldAlert], ['chatbot', 'Travel desk', Bot]]
