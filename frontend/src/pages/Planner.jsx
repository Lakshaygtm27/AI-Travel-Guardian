...
export default function Planner() {
	...
	const generate = async (event) => {
		...
		try { const response = await api.post('/api/itinerary', { ...form, days: Number(form.days), budget: Number(form.budget) }); setItinerary(response.data.itinerary) } catch (requestError) { setError(diagnosticMessage(requestError)) } finally { setLoading(false) }
	}
